...
<MainHeading> Getting Started- Create a NextJs App</MainHeading>

Now that you understand what Next.js is and why it's needed, let's see how to 
create a NextJs app..

while a NextJs app can be created manually, the easiest and recommended way is to use a 
...
Before we install NextJs, let's make sure our device meets the system requirements.
To be able to install NextJs you'll need:
