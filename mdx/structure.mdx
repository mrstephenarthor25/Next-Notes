...
<MySection>
    ...
    the src folder, the role of key files and folders, and some common mistakes you should avoid
     ...
     <Info>
        ...
        - This lesson is designed to be concise. If you'd like some more details on the Next.js 15 project structure you can check out <MYLink href="/blog/Next.js-project-Structure" text="this blog article"/>
    </Info>
