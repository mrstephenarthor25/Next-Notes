...
<Info>
    The folder structure discussed in this lesson uses the App Router that was introduced in Next.js 13. Today, more than ever, this has become the recomended standard. Don’t worry if you don't know what the App router is, we'll talk about it in another lesson  
...
<MyH2>Next.js Project Files and Folders</MyH2>
    ...
    <MySection>
        ...
        <SampleImage src={top_level_folders} alt="Top level folders of a Next.js 15 project (with and without the src directory )" caption={"Top level folders of a Next.js 15 project (with and without the src directory )"}/>
        ...
        The app folder is the core of your Next.js project. This folder holds your pages, layouts, templates and loading state UI (the user interface that is shown when component is still loading) and is used to determine which page is shown when users visit your Next.js app.
        <Info>
        ...
        <Info>
            ...
            Also, Next.js 15 automatically attempts to cache static versions of the pages of your application in the build folder, unless the page is one that needs to rendered dynamically (more on this in another article). 
    ...
    <MySection>
        ...
        <Info>
            Next.js as a framework has it's file conventions. If any of your folders, contained in the app directory has any of these files (page.tsx,layout.tsx and several others not added by default), the folder is automatically conidered to be route.
        </Info>
    ...
    <MySection>
        ...
        Private folders give you the opportunity to explicityly tell Next.js, "hey i don't want this folder to be treated as a route".
...
<MySection>
    <MyH2>Best Practices For Maintaining your Next.js 15 project</MyH2>
</MySection>
