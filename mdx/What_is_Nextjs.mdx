...
with React. In my opinion, it has done just that!

At the time, some said it's the next big thing. Others said it's just the next
...
With NextJs you get all the benefits of the React and more out of the box:
...
+ SEO features included too e.g automatic image optimization.
...
have to worry about when using just react. And the cherry on top - it's easy to maintain.
